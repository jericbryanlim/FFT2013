...
<div id="3" style="display:none">
    ...
    <div id="choices" class="menucol1cust">SANDWICHES 
        <div id="price">$8/ea</div><br>
        ...
        <br>
        <br>
        <div id="choices">DESSERTS
            <div id="price">$5/ea</div><br>
            <div class="subchoices">
    ...
    <div id="choices" class="menucol2cust">SIDES
        <div id="price">$4/ea</div><br>
        <div class="subchoices">  
        ...
        <br>
        <br>
        <div id="choices">DRINKS<br></div>
        <br>

            <div class="subchoices">
            <?php echo $dropdown; ?> &nbsp; Mineral Water   <div id="price">$2/ea</div><br>               
            <?php echo $dropdown; ?> &nbsp; Canned Drinks   <div id="price">$3/ea</div><br>                  
            <?php echo $dropdown; ?> &nbsp; Bottled Drinks  <div id="price">$4/ea</div><br>
        <br>
        <br>
        <br>
        ...
        <div class="subchoices">
        <?php echo $dropdown; ?><b>+$50/ea</b> deposit
        </div>
        </div>
        </div>
    </div>
    
    <div id="choices" class="menucol3cust">WINE<br>
        <div class="subchoices">
