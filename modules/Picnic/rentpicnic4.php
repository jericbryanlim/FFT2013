...
<div id="2" style="display:none">
    ...
    <div id="choices" class="menucol14">CHOOSE <?php echo $four; ?>SANDWICHES<br>
        ...
        <br>
        <br>
        <div id="choices">CHOOSE <?php echo $four; ?>DESSERTS<br>
    ...
    <div id="choices" class="menucol24">CHOOSE <?php echo $four; ?>SIDES<br>
        <div class="subchoices">  
        ...
        <br>
            ...
            <div class="subchoices">
            <input type="radio" name="drinks">4 x Bottled Drinks                  <br>
            <input type="radio" name="drinks">4 x Canned Drinks, 2 x Mineral Water<br> 
            <input type="radio" name="drinks">8 x Mineral Water                   <br>
        <br>
        <br>
        <br>
